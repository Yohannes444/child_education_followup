...
const MaterialListView= (props)=>{
  ...
  const columns = [
    ...
    { title: 'Description', field: 'description' },
    {
      ...
      field: 'file',
      render: (rowData) => (
        <button onClick={() => handleFileClick(rowData.file)}>
  ...
  const data = props.uploadState.materialList.map((material) => ({
    ...
    file: material.file,
      ...
      if(props.uploadState.isLoading){
        return(
